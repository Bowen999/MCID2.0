  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      <div style={{ flex: '4', padding: '0 20px' }}>
        ...
        <p>As an upgraded version of previous MyCompoundID, MCIDxKEGG predicted theoretical metabolites based on metabolites from KEGG compound database via 76 biological reactions.</p>
